    ...
    <div className="bg-ivory">
      ...
      <section className="max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            { icon: <TrendingUp size={22} className="text-gold" />, title: "BCS English", desc: "Targeted preparation for BCS preliminary and written — vocabulary, grammar, translation, and précis writing." },
            { icon: <Users size={22} className="text-gold" />, title: "Admission English", desc: "University and medical admission English — question pattern analysis, rapid revision, and mock test sessions." },
          ].map((item) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="font-serif text-ivory text-4xl font-semibold leading-tight mb-6">
                Why students
                <br /><span className="italic">choose us.</span>
              </h2>
      ...
      <section className="max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            { name: "Rafiul Hasan", role: "SSC 2024 — GPA 5.0", text: "My English was the weakest subject. White-Collar turned it into my highest-scoring one. The structured approach and mock tests made all the difference." },
            { name: "Nusrat Jahan", role: "HSC 2024 — A+", text: "The composition and comprehension classes are exceptional. I walked into my HSC exam fully prepared. Got A+ in English First and Second Paper both." },
            { name: "Tanvir Ahmed", role: "BCS 44th Batch", text: "BCS English is tricky but the targeted sessions here covered exactly what comes in the exam. Cleared the English section comfortably in the preliminary." },
          ].map((t) => (
            <div key={t.name} className="p-6 border border-cream-dark bg-white rounded-sm shadow-premium">
              <div className="flex gap-1 mb-4">{Array.from({ length: 5 }).map((_, i) => <span key={i} className="text-gold text-sm">★</span>)}</div>
              <p className="text-charcoal/70 text-sm leading-relaxed mb-5 italic">"{t.text}"</p>
