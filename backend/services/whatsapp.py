...
def build_payment_confirmation_message(student_name: str, invoice_number: str, amount: float, description: str, paid_at: str) -> str:
    return (
        f"✅ *White-Collar English Care*\n"
        f"━━━━━━━━━━━━━━━━━━━━\n"
        f"Payment Confirmed for *{student_name}*\n\n"
        f"🔢 Invoice #: {invoice_number}\n"
        f"📋 Description: {description}\n"
